...
double delta_teta_i = 5.0 * Pi/180;
double delta_fii_i = 0.0 * Pi/180;
//
int pol = -1; //0 - lineaara; 1 = pa labi; -1 = pa kreisi
...
int int_phase_deg[2] = {90, -90};
int int_alpha_deg[2] = {0, 0};
...
double teta_o[2] = {teta_i, teta_i}; //ar komatu atdala pirmo un otro komponenti
double fii_o[2] = {fii_i, fii_i}; //{0, Pi/2}; //
//
...
double teta_p[2] = {teta_i, teta_i}; //{0, Pi/2}; // ar komatu atdala pirmo un otro komponenti
double fii_p[2] = {fii_i, fii_i}; //{0, Pi/2}; //{0, Pi/2}; //{Pi, Pi}; //{Pi, Pi}; //
...
int main(){
	...
	for(int Ri = 0; Ri <= 3; Ri += 1){ //sheit izvelas un ievieto vajdzigos rabi indeksus, kas atbilsti rabi frekvencem kas definetas augstak/ Taisa rabi ciklus sakas ar Ri= un beigu vertiba Ri< un Ri+= saka par cik palielinat katru nakamo
