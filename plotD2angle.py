...
def getFilePathD2Angle(rabi, pol, theta, phi, phase=[100, -100], alpha=[-40, 0]):
    ...
    folderName = f'/home/laima/Documents/Pētījumi/AOC Rb (2018-)/Test_D2_excitation_angle/' \
                 f'Pump_D2-Cs133_Probe_D2-Cs133/gamma=0.0190-DSteps=150-DScan=2.00sigma-lWidth=2.0/' \
                 f'Pump_4-4-theta={theta:.2f}-phi={phi:.2f}-pol={pol}-det=25_Probe_4-4-det=25/' \
                 f'Absorption_theta={theta:.2f}-{theta:.2f}_phi={phi:.2f}-{phi:.2f}_pol=1--1_ph=100--100_a=-40-0_gammaprobe=0.0190_lWidthpr=2.0'
...
if __name__ == '__main__':
    ...
    # plt.tight_layout()
    plt.savefig('/home/laima/Documents/Pētījumi/AOC Rb (2018-)/Figures_AOC_Cs_20220112/D2_angle/D2_angle_diff.png')
