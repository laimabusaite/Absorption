...
def getFluorescenceFilePath(rabi):
    fileName = f'LIF_Cs133-D1-Rabi={rabi:.2f}-shift=0.0-Ge=0'
    foldername0 = f'/home/laima/Documents/Pētījumi/AOC Rb (2018-)/Absorption/Pump_D1-Cs133_Probe_D2-Cs133/gamma=0.0190-DSteps=300-DScan=4.00sigma-lWidth=2.0/Pump_4-3-theta=0.79-phi=1.57-pol=0-det=0_Probe_4-4-det=25/LIF_theta=1.57-1.57_phi=0.00-0.00_pol=1--1'
...
if __name__ == '__main__':
    ...
    fluor_path = getFluorescenceFilePath(rabi)
    print(fluor_path)

    theorData = importData(fluor_path)
